...
class MeditationAnimation extends StatefulWidget {
  @override
  _MeditationAnimationState createState() => _MeditationAnimationState();
}

class _MeditationAnimationState extends State<MeditationAnimation>
